...
export const searchClients = (clients) => {
    ...
    clients.forEach(client => {
        ...
        const fintLink = document.createElement('a')

        findItem.classList.add('find-list__item')
        fintLink.classList.add('find-list__link')

        fintLink.textContent = `${client.name} ${client.surname} ${client.lastName}`
        fintLink.href = '#'
        
        findItem.append(fintLink)
